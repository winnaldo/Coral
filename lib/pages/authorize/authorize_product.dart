...
class AuthorizeProduct extends StatefulWidget {
  final String name;
  ...
  @override
  State<AuthorizeProduct> createState() => _AuthorizeProductState();
}

class _AuthorizeProductState extends State<AuthorizeProduct> {
  @override
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => SuccessAuthorize(
                            authorizedTo: authorizedTo.PRODUCT,
                          ),
                        ),
                      );
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => SuccessAuthorize(
                            authorizedTo: authorizedTo.DELIVER,
                          ),
                        ),
                      );
                    },
