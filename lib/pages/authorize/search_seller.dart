...
import 'package:coral_ui/pages/authorize/authorize_seller.dart';
    ...
    Future.delayed(
      ...
      () async => setState(
        () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AuthorizeSeller(),
          ),
        ),
      ),
    );
              ...
              Row(
                children: [
                  ...
                  Image(
                    height: 22.w,
                    width: 22.w,
                    image: const AssetImage('lib/imgs/store.png'),
                  ),
                  SizedBox(
                    width: 10.w,
                  ),
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              Text(
                                "Always check the legitimation of the Seller's business information before verifies them to Coral",
