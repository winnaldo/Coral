...
class SuccessAuthorize extends StatefulWidget {
  final authorizedTo;
  const SuccessAuthorize({super.key, required this.authorizedTo});

  @override
  State<SuccessAuthorize> createState() => _SuccessAuthorizeState();
}

class _SuccessAuthorizeState extends State<SuccessAuthorize> {
  @override
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            if (widget.authorizedTo == authorizedTo.SELLER) ...{
                              SizedBox(
                                width: 128.w,
                            ...
                            } else if (widget.authorizedTo ==
                                authorizedTo.PRODUCT) ...{
                              SizedBox(
                                width: 128.w,
                                child: SingleChildScrollView(
                                  reverse: true,
